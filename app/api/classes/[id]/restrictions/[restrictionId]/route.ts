...
export async function PUT(
  ...
  try {
    ...
    const restrictionId = params.restrictionId;
    ...
    const restriction = await enrollmentConfigService.updateRestriction(
      restrictionId,
      body,
      user.id
    );
...
export async function DELETE(
  ...
  try {
    ...
    await enrollmentConfigService.removeRestriction(restrictionId, user.id);
