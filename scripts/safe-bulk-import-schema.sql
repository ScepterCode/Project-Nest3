-- =====================================================
-- SAFE BULK IMPORT SCHEMA
-- Version that handles existing objects gracefully
-- =====================================================
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Users can view their institution's bulk imports" ON bulk_imports;
    DROP POLICY IF EXISTS "Institution admins can manage bulk imports" ON bulk_imports;
    DROP POLICY IF EXISTS "Users can view errors for their institution's imports" ON import_errors;
    DROP POLICY IF EXISTS "Users can view warnings for their institution's imports" ON import_warnings;
    DROP POLICY IF EXISTS "Users can view progress for their institution's imports" ON import_progress;
    DROP POLICY IF EXISTS "Institution admins can manage snapshots" ON migration_snapshots;
    DROP POLICY IF EXISTS "Users can view their own import notifications" ON import_notifications;
EXCEPTION
...
DROP TRIGGER IF EXISTS update_import_progress_updated_at ON import_progress;
